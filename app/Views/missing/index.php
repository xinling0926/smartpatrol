<div class="box box-primary" id="report_condition">
	...
	<div class="box-body">
		...
		<div class="form-group">
			<label class="col-sm-2 control-label"><?=lang('Missing.label_report_name')?></label>
			<div class="col-lg-4 col-sm-8"><?= form_dropdown_input('fmd0101', $fmd01s, '', '', ['onchange' => 'select_report(this)']) ?></div>
		</div>
		<div class="form-group" hidden>
			<label class="col-sm-2 control-label"><?=lang('Missing.label_report_month')?></label>
		...
		<div class="form-group">
			<label class="col-sm-2 control-label"><?=lang('Missing.label_report_time')?></label>
	...
	<div class="box-footer">
		<button type="button" class="btn btn-primary pull-right" onclick="show_report()"><i class="fa fa-search"></i> <?= lang('Globe.toolbar_search') ?></button>
	</div>
	<?= form_close() ?>
</div>
