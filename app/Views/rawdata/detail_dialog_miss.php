...
<div class="row">
	<div class="col-md-6">
		<div class="form-horizontal">
			...
			<div class="form-group">
				<label class="col-sm-4 control-label"><?=lang('label_fmd0804')?></label>
				<div class="col-sm-8">
					<div class="form-control"><?= $data->fmd0804 ?></div>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-4 control-label"><?=lang('label_fmd0204')?></label>
				<div class="col-sm-8">
					<div class="form-control"><?= $data->fmd0204 ?></div>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-4 control-label"><?=lang('label_fmd0908')?></label>
				<div class="col-sm-8">
					<div class="form-control"><?= $data->fmd0908 ?></div>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-4 control-label"><?=lang('label_fmd0703')?></label>
				<div class="col-sm-8">
					<div class="form-control"><?= $data->fmd0703 ?></div>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-4 control-label"><?=lang('label_pad0109')?></label>
				<div class="col-sm-8">
					<div class="form-control"><?= $data->pad0109 ?></div>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-4 control-label"><?=lang('label_sys0103')?></label>
				<div class="col-sm-8">
					<div class="form-control"><?= $data->sys0103 ?><?= $data->sys0104 ?></div>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-4 control-label"><?=lang('label_juli')?></label>
				<div class="col-sm-8">
					<div class="form-control"><?= $data->juli ?></div>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-4 control-label"><?=lang('label_pad0112')?></label>
				<div class="col-sm-8">
					...
					<div class="form-group">
						...
						<div class="col-sm-4">
							<div style="padding-top: 7px;">
								...
								<?php } ?>
								<?php if(isset($val['info']) && !empty($val['info'])){ ?><textarea cols="18" rows="2"><?= $val['info'] ?></textarea><?php } ?>
							</div>
						</div>
					</div>
...
<script type="text/javascript">
    function show_image(img) {
        ...
        var html = "<a href=\"" + img + "\" target=\"_blank\"><img src=\"" + img + "\" style=\"max-width: 100%\"/></a>";
        layer.open({
            type: 1,
