				...
				<div>
					<form id="query_form" accept-charset="utf-8" method="post" target="_blank">
						<div class="pull-right" style="margin-bottom:10px;">
							...
							<a href="#" class="btn btn-primary" onclick="$('#query_form').attr('action', base_url + 'repair-from/export');$('#query_form').submit();" style="float:left;margin-left:5px;"><i class="fa fa-cloud-download"></i> <?=lang('export_excel_btn')?></a>
                        </div>
					<?=form_close() ?>
				</div>
